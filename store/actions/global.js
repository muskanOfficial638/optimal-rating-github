...
export default {
  getData: (payload) => async (dispatch) => {
    try {
      payload.key && dispatch({ type: types.GLOBAL_REQUEST, ...payload });
      const data = await DashboardProxy.getData(payload);
      payload.key &&
        dispatch({ type: types.GLOBAL_SUCCESS, key: payload.key, data });
      return data;
    } catch (error) {
      payload.key &&
        dispatch({ type: types.GLOBAL_ERROR, key: payload.key, error });
      throw error;
    }
  },
  postData: (payload) => async (dispatch) => {
    try {
  ...
  putData: (payload) => async (dispatch) => {
    try {
  ...
  patchData: (payload) => async (dispatch) => {
    try {
  ...
  deleteData: (payload) => async (dispatch) => {
    try {
  ...
  headData: (payload) => async (dispatch) => {
    try {
